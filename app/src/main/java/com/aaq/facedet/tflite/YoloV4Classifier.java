...
package com.aaq.facedet.tflite;
...
import com.aaq.facedet.env.Utils;
...
public class YoloV4Classifier implements Classifier {
    ...
    private static int layer_size = 735;
    // tiny or not
    private static boolean isTiny = false;

    // config yolov4 tiny
    private static final int[] OUTPUT_WIDTH_TINY = new int[]{layer_size, layer_size};
    private static final int[] OUTPUT_WIDTH_FULL = new int[]{layer_size, layer_size};
